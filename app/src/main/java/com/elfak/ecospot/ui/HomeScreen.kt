            ...
            Column(Modifier.fillMaxWidth().padding(16.dp)) {
                        ...
                        FilterChip(
                            ...
                            onClick = {
                                if (mapState.filterWasteType == wasteType) {
                                    mapViewModel.onWasteTypeChanged(null) // Poništi filter klikom na isti
                                } else {
                ...
                Button(
                    onClick = {
                        ...
                        sliderPosition = 10f // Resetuj i poziciju slajdera
                    },
                    modifier = Modifier.fillMaxWidth()
                ) {
        ...
        Box(modifier = Modifier.padding(paddingValues)) {
            if (hasLocationPermission) {
                ...
                GoogleMap(
                    ...
                    // Crtanje lokacije korisnika (plavi krug)
//                    mapState.lastKnownLocation?.let { location ->
//                        Circle(center = location, radius = 30.0, strokeWidth = 0f, fillColor = Color(0x330084F4), zIndex = 1f)
//                        Circle(center = location, radius = 8.0, strokeColor = Color.White, strokeWidth = 4f, fillColor = Color(0xFF0084F4), zIndex = 2f)
//                    }
